...
<body>
  <?php $currentPage = '../'; ?>
  <?php $ids = $_POST['userID']; ?>

  <?php
    $result=mysqli_query($conn,"SELECT * FROM `tbl_showhide` WHERE `id` = $ids");
    while($row=mysqli_fetch_array($result))
    {
      $index = $row['tablename'];
      $Page= str_replace("tbl_","",$row['tablename']);
      $PageName = strtoupper(str_replace("_"," ",$Page));
    }
  ?>
  <input type="hidden" id="hidedynamictable" value="<?php echo $index; ?>" >
    <!-- ============================================================== -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title"><?php echo $PageName; ?> Details </h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                  <li class="breadcrumb-item"><a href="dashboard">Home</a></li>
                                  <li class="breadcrumb-item active" aria-current="page"><?php echo $PageName; ?> Details</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-6 col-md-4 col-sm-12 text-right smalloncheck">
                                  <div class="bh_chart hidden-sm">
                                      <div class="float-right m-r-15">
                                          <h4 class="card-title">
                                            <small onclick="addinformation();" id="addinformationid"><i class="icon-plus"></i> &nbsp; Add User</small>
                                          </h4>
                                      </div>
                                  </div>
                                  <div class="bh_chart hidden-xs">
                                      <div class="float-right m-r-15">
                                          <h4 class="card-title">
                                            <small onclick="viewinformation();" id="viewinformationid"><i class="icon-eye"></i> &nbsp; View User</small>
                                          </h4>
                                      </div>
                                  </div>
                                </div>
    ...
    <script type="text/javascript">
      ...
      function addload(){
        var sid = document.getElementById("hidedynamictable").value;
      ...
      function informationload(){
        $.ajax({
            type:'POST',
            url:'../tabledisplay/pages/users.php',
            success:function(html){
